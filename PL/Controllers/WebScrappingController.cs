...
namespace PL.Controllers
{
    public class WebScrappingController : Controller
    {
        public ActionResult MLSearch()
        {
            ...
            //Lista de Descripciones de los productos
            IList<IWebElement> descripciones = driver.FindElements(By.ClassName("ui-search-layout"));

            //Lista de Descripciones de los productos

            IList<IWebElement> precios = driver.FindElements(By.ClassName("ui-search-price__part--medium"));
            ...
            prod.Productos = new List<object>();

           prod.lista = new List<object>();    

            foreach (var e in descripciones)
            {
                //   string nombre = driver.FindElements(By.ClassName("ui-search-item__brand-discoverability")).ToString();

                ML.Producto producto = new ML.Producto();

                //  productoML.Descripcion = 
                producto.Descripcion = e.Text;

                prod.lista.Add(producto);
            }
